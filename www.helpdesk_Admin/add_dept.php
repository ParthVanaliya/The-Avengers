...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-75">
      <input type="text" id="name" name="dname" placeholder="Enter name..">
    </div>
  </div>
   ...
   <div class="row">
    ...
    <div class="col-75">
      <input type="text" id="fname" name="did" placeholder="Enter ID..">
    </div>
  </div>
  ...
  <div class="row">
    ...
    <div class="col-75">
      <input type="text" id="fname" name="desi" placeholder="Enter Description..">
    </div>
  </div>
	<div class="row">
    <div class="col-25">
